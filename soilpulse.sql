...
CREATE TABLE `containers` (
  ...
  CONSTRAINT `containers_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE NO ACTION,
  CONSTRAINT `containers_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `containers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
(56,	'Jonas\' dissertation',	'10.5281/zenodo.6654150',	1);
